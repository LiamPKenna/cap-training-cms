...
export function watchFirebaseLessonsRef() {
  return dispatch => {
    db.ref('/epi/lessons').on('child_added', params => {
...
export function watchFirebaseCoursesRef() {
  return dispatch => {
    db.ref('/epi/courses').on('child_added', params => {
